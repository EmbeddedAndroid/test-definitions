...
scp -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no $1:/tmp/dslr/* .
ssh -o UserKnownHostsFile=/dev/null -o StrictHostKeyChecking=no $1 -C "rm -rf /tmp/dslr"
